...
function Content({ updateCartCount }) {
  const [enlargedImage, setEnlargedImage] = useState('ball.png');
  ...
  return (
    <div className='body'>
      <div className="parent">
        <div className='col-1'>
          <ul>
            <li><img src="ball.png" alt="Ball" onClick={() => handleImageClick('ball.png')} /></li>
            <li><img src="ball.png" alt="Ball" onClick={() => handleImageClick('ball.png')} /></li>
            <li><img src="Vector.png" alt="Vector" onClick={() => handleImageClick('Vector.png')} /></li>
          </ul>
        </div>
        <div className="col-2">
          <ReactImageMagnify
